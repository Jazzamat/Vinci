...
def load_covers():
    filelist = glob.glob("/home/omer/Documents/Vinci/vinci-core/local_assets/Tracks_and_Covers/*/cover (64, 64).png")
    ...
    images_array = np.array([np.array(Image.open(fname)) for fname in filelist[:10]])
